 ...
 * SOEM write to Beckhoff Automation GmbH, Eiserstra? 5, D-33415 Verl, Germany
 * (www.beckhoff.com).
 */
...
ec_adaptert * oshw_find_adapters (void)
{
   ...
   pcap_if_t *d;
   ec_adaptert * adapter;
   //ec_adaptert * prev_adapter;	  // original source code.
   ec_adaptert * prev_adapter = NULL; // robotous change to avoid the C4703 compiling error
