...
#ifdef NEW_FILTER	//khan
	unsigned char m_rcvd_filter_setting_value_1;	// krhan received filter setting value 
	unsigned char m_rcvd_filter_setting_value_2;	// krhan received filter setting value
#else
...
#ifdef NEW_FILTER	
	double m_rcvdTemperature;					// received Temperature of RFT
	unsigned char m_measure_error;
#else
	float m_rcvdTemperature;					// received Temperature of RFT
#endif
...
#ifdef NEW_FILTER
	bool DFG_set_filter_type(unsigned char data_field[COMMAND_PACKET_DATA_FIELD_SIZE], unsigned char filter_type, unsigned char set_value_1, unsigned char set_value_2); // krhan
#else
...
#ifdef NEW_FILTER
	bool UPG_set_filter_type(unsigned char packet_buff[UART_COMMAND_PACKET_SIZE], unsigned char filter_type, unsigned char set_value_1, unsigned char set_value_2); // krhan
#else
